  ...
  return (
    <div className="login-wrapper">
      ...
      >
        ...
        {isTelegram && (
          <div className="inapp-banner" style={{ borderColor: 'rgba(41, 182, 246, 0.4)' }}>
            <span className="inapp-banner-icon">📱</span>
            <div className="inapp-banner-text">
              <strong>Telegram Mini App</strong>
              <p>Войдите по email или попробуйте без регистрации</p>
            </div>
          </div>
        )}

        {/* ═══ GOOGLE BUTTON (hidden in Telegram — blocked by Google) ═══ */}
        {!isInAppBrowser && !isTelegram && !googleRedirecting && (
        ...
        <div className="login-divider"><span>{mode === 'reset' ? 'сброс пароля' : isTelegram ? 'вход по email' : 'или по email'}</span></div>
