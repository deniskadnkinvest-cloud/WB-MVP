    ...
    <div className="app-wrapper">
      <header className="app-header">
        ...
        <div style={{marginTop:8,display:'flex',alignItems:'center',justifyContent:'center',gap:8}}>
          ...
          <button onClick={signOut} style={{fontSize:'0.7rem',color:'var(--text-muted)',background:'none',border:'1px solid var(--border-subtle)',borderRadius:4,padding:'3px 8px',cursor:'pointer',fontFamily:'Inter'}}>Выйти</button>
        </div>
      </header>
