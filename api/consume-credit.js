...
// РЎРїРёСЃР°РЅРёРµ РєСЂРµРґРёС‚РѕРІ Р·Р° РіРµРЅРµСЂР°С†РёСЋ
...
/**
 * РќР°Р№С‚Рё РїРѕР»СЊР·РѕРІР°С‚РµР»СЏ РІ PostgreSQL (Р°РЅР°Р»РѕРіРёС‡РЅРѕ subscription.js).
 */
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // РђС‚РѕРјР°СЂРЅРѕРµ СЃРїРёСЃР°РЅРёРµ РєСЂРµРґРёС‚РѕРІ СЃ РїСЂРѕРІРµСЂРєРѕР№ РЅР°Р»РёС‡РёСЏ
    ...
    if (result.rows.length === 0) {
      // РџСЂРѕРІРµСЂСЏРµРј РїСЂРёС‡РёРЅСѓ РѕС€РёР±РєРё
